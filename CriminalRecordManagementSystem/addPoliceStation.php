	...
	<body>
		...
		<div class="content-container">
			<div class="container-fluid">
				<div class="wrapper">
					<div class="title">New Police Station</div>
					<div class="form">
						<form action="addPoliceStation_action.php" method="post">
							<div class="inputfield">
								<label>Police Station</label>
								<input type="text" class="input" name="staname" placeholder="Police Station" required>
							</div> 
							<div class="inputfield">
							...
							<div class="inputfield">
								...
								<div class="custom_select">
									<select name="statype">
									<option value="Police" name="statype">PoliceStation</option>
									<option value="Trafficpolice" name="statype">Traffic PoliceStation</option>
									<select>
								</div>
							</div>
							<div class="inputfield">
							  <label>UserName</label>
							  <input type="text" class="input" name="stausr" placeholder="UserName" required>
							</div>
							<div class="inputfield">
							  <label>Password</label>
							  <input type="password" class="input" name="stapass" placeholder="Password" required>
							</div> 
							<div class="inputfield">
