	...
	<body>
		...
		<div class="content-container">
			<div class="container-fluid">
				<form action="adminSearchCriminalAction.php" method = "get">
			...
			<?php
				...
				if ($result->num_rows > 0) {
					...
					while($row = $result->fetch_assoc()) {
						...
						<input style="margin-top:10px;" type="button" value="Update" class="btn"
								onclick="location.href='updateCriminal.php<?php echo '?id='.$row['criminalid']; ?>';">
				<?php			
					}
				} 
				else {
					echo "<div id='card'><p>Record does not Exist</p><form action='adminSearchCriminal.php' method='get'>
