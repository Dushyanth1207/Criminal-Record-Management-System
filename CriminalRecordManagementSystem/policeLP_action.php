...
<html>
	...
	<body>
		...
		<?php
			...
			$sql = "SELECT a.* FROM authentication a,station s WHERE s.stationtype='police' AND s.username='$un' AND 
					a.username='$un' AND a.password='$pass'";
			$result = $conn->query($sql);
			$n = $result->num_rows;

			if ($result->num_rows > 0) {
				$_SESSION["loggedin"]="police";
				...
				echo "<div id='card'>
						...
						<form action='policeLoginPage.php' method='post'>
