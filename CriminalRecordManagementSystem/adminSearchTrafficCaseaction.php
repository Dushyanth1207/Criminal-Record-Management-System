			...
			<?php
					...
					if ($result->num_rows > 0) {
						...
						while($row = $result->fetch_assoc()) { ?>
							...
							<a class="b" href="updateTrafficCase.php<?php echo '?id='.$row['caseno']; ?>">Update</a></td></tr>
						</table>
						<?php			
						}
					} 	
					else {
						echo "<div id='card'><p> Traffic Record doesnot Exist !</p><form action='adminSearchTrafficCase.php' method='get'>
