...
<body>
		<div class="sidebar-container">
			<div class="sidebar-logo">POLICE</div>
				<ul class="sidebar-navigation">
					...
					<li>
					  <a class="nav-link-active" href="searchFIR.php">
		...
		<div class="content-container">
			<div class="container-fluid">
				<form action="searchFIRaction.php" method = "get">
					<table class="elementsContainer">
						<tr>
							<td><input type="text" class="search" name="firnum" placeholder="Search FIR"></td>
				...
				<?php
					...
					$firnum = filter_input(INPUT_GET,'firnum');
					
					$sql = "SELECT * FROM fir WHERE firno='$firnum'";
					...
					if ($result->num_rows > 0) {
						...
						while($row = $result->fetch_assoc()) { ?>
							...
							<tr><td>   FIR No: </td><td><?php echo $row['firno'] ; ?></td></tr>
							<tr><td>   Station ID : </td><td><?php echo $row['stationid']; ?></td></tr>
							<tr><td>   Victim Name : </td><td><?php echo $row['victimname']; ?></td></tr>
							<tr><td>   Informer Name : </td><td><?php echo $row['informername']; ?></td></tr>
							<tr><td>   Date: </td><td><?php echo $row['date']; ?></td></tr>
							<tr><td>   Time : </td><td><?php echo $row['time']; ?></td></tr>
							<tr><td>   Criminal Name : </td><td><?php echo $row['criminalname']; ?></td></tr>
							<tr><td>   Criminal Type : </td><td><?php echo $row['crimetype']; ?></td></tr>
							<tr><td>   Description Of Incident: </td><td><?php echo $row['description']; ?></td></tr>
						</table>	
				<?php			
					}
				} 
				else {
					echo "<div id='card'><p>Record not Exist</p><form action='searchFIR.php' method='get'>
